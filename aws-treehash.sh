...
# to the log base 2
# 
# This means that it does it in O(Log N) memory complexity. :-)
# The Java example by AWS keeps all the hash values and sums them together at the end --
# O(N + LOG(N)) memory complexity. :-P Bash wins again!!
